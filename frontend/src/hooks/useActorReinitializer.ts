...
export function useActorReinitializer() {
  ...
  const startReinitialization = useCallback(async (
    ...
    console.log('═══════════════════════════════════════════════════════════════════════════');
    console.log('🔄 [Actor Reinitializer] Starting automatic reinitialization cycle');
    console.log('═══════════════════════════════════════════════════════════════════════════');
    ...
    for (let attempt = 0; attempt < MAX_REINIT_ATTEMPTS; attempt++) {
      ...
      try {
        ...
        // Success!
        console.log('═══════════════════════════════════════════════════════════════════════════');
        console.log(`✅ [Reinitializer] Reinitialization successful on attempt ${attempt + 1}`);
        ...
        if (attempt === MAX_REINIT_ATTEMPTS - 1) {
          ...
          console.error('═══════════════════════════════════════════════════════════════════════════');
          console.error('❌ [Reinitializer] All reinitialization attempts failed');
          console.error('═══════════════════════════════════════════════════════════════════════════');
